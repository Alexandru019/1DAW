...
public class Test {
	...
	public static void main(String[] args) {
			 ...
			 ProfesorInterino pi1 = new ProfesorInterino("Arcadio", "Hernández López", 45, "45221887-K", fecha1);
			 ...
			 ProfesorTitular pt2 = new ProfesorTitular ("Ismael", "Centa Mota", 49, "88-L");
